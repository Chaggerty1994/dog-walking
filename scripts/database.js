...
//  defining and exporting a function that seperates and makes a copy 
// of all the walkers in the database
export const getWalkers = () => {
    return database.walkers.map(walker => ({...walker}))
}

// defining and exporting a function that seperates and
// makes a copy of all the pets in the database
...
// defining and exporting  function that makes a copy of the cities
...
// individual walkers cities


export const getWalkerCities = (walker) => {
    return database.walkerCities.map(walkercity => {
...
export const findCities = (walkerCities) => {
